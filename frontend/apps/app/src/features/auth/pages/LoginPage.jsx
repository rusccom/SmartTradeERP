  ...
  return (
    <section className="auth-shell">
      <form className="auth-card auth-form" onSubmit={handleSubmit}>
        ...
        <label className="auth-label" htmlFor="client-email">{t("auth.email")}</label>
        <input id="client-email" name="email" className="auth-input" type="email" value={form.email} onChange={handleChange} required />
        <label className="auth-label" htmlFor="client-password">{t("auth.password")}</label>
        <input id="client-password" name="password" className="auth-input" type="password" value={form.password} onChange={handleChange} required />
