...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
    ...
    if err != nil {
        httpx.WriteError(w, http.StatusInternalServerError, "internal_error", "failed to create product", err.Error())
        return
    }
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
    ...
    if err != nil {
        httpx.WriteError(w, http.StatusInternalServerError, "internal_error", "failed to update product", err.Error())
        return
    }
